...
<head>
    ...
    <title>Tabla de jornadas | Sistema de Gestión UEBF</title>
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="container">
                <h1 class="mt-1 text-center text-dark fw-bold">Tabla de jornadas</h1>
                <div class="mb-4 mt-3">
                ...
                <div class="mb-4 mt-3">
                    <div class="row justify-content-start">
                        <div class="col-auto">
                            <a href="../../Crud/jornada/agregar_jornada.php" class="btn btn-primary">Agregar Jornadas</a>
                        </div>
                        <div class="col-auto">
                        ...
                        <tbody>
                            <?php while ($fila = $resultado->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../../Crud/jornada/editar_jornada.php ?id=<?php echo $fila['id']; ?>" class="btn btn-sm btn-primary">Editar</a>
                                        <a href="../../Crud/jornada/eliminar_jornada.php ?id=<?php echo $fila['id']; ?>" class="btn btn-sm btn-danger">Eliminar</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
