                    ...
                    <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../../Crud/administrador/editar_admin.php?cedula=<?php echo $fila['cedula']; ?>"
                                        class="btn btn-warning btn-action">Editar</a>
                                    <a href="../../Crud/administrador/eliminar_admin.php?cedula=<?php echo $fila['cedula']; ?>"
    ...
    $(document).ready(function() {
        ...
        $('#searchCedula').keyup(function() {
            $('#dataTable').DataTable().column(
                3) // Reemplaza el número con el índice de la columna de cédula
                .search($(this).val())
                .draw();
        });
