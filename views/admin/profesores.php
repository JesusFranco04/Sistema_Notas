    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header bg-danger text-white">
                <h5 class="mb-0">Tabla de Profesores</h5>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-4">
                ...
                <div class="action-buttons ml-auto mb-3">
                    <a href="../../Crud/profesores/agregar_profesor.php" class="btn btn-primary btn-action">Agregar
                        Profesor</a>
                    <a href="reporte_profesores.php" class="btn btn-success btn-action">Generar reportes</a>
                </div>
                    ...
                    <table class="table table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="../../Crud/profesores/editar_profesor.php?id=<?php echo $fila['id']; ?>"
                                        class="btn btn-sm btn-primary">Editar</a>
                                    <a href="../../Crud/profesores/eliminar_profesor.php?id=<?php echo $fila['id']; ?>"
                                        class="btn btn-sm btn-danger"
                                        onclick="return confirm('¿Está seguro de eliminar este profesor?')">Eliminar</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
