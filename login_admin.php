                                    ...
                                    <div class="p-5">
                                        ...
                                        <form class="user">
                                            <div class="form-group">
                                                <label
                                                    for="identificationNumber">Número
                                            ...
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputPassword">Contraseña</label>
                                                <div class="input-group">
                                                    ...
                                                    <div
                                                        ...
                                                        <button
                                                            ...
                                                            type="button"
                                                            onclick="MostrarClave()">Mostrar</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <a href="http://localhost/sistema_notas/views/admin/index_admin.html"
