                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block"
                                style="background-image: url('imagenes/admin.png'); background-size: 90% auto; background-position: center; background-repeat: no-repeat;">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h1 text-gray-900 mb-3">Iniciar
                                            Sesión</h1>
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="http://localhost/sistema_notas/views/admin/index_admin.php"
