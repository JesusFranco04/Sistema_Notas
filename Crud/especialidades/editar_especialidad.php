...
<div>
    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
        ...
        <a href="../../views/admin/especialidades.php">Regresar</a>
    </form>
</div>
<?php
    } else {
...
if (isset($_POST['actualizar'])) {
    ...
    if (!empty($nombre) && !empty($fecha_ingreso)) {
        ...
        $sql2 = "UPDATE especialidades SET nombre=?, fecha_ingreso=? WHERE id=?";
...
<head>
    ...
    <title>Editar Especialidad| Sistema de Gestión UEBF</title>
