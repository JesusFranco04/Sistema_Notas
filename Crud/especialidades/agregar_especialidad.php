...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nombre) && !empty($fecha_ingreso)) {
        ...
        $sql = "INSERT INTO especialidades (nombre, fecha_ingreso)
                VALUES ('$nombre', '$fecha_ingreso')";
                
        if (mysqli_query($conn, $sql)) {
            header("Location: ../../views/admin/especialidades.php");
...
<head>
    ...
    <title>Agregar Especialidaes| Sistema de Gestión UEBF</title>
...
<body>
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                <form action="agregar_especialidad.php" method="post" enctype="multipart/form-data"
                    ...
                    <a href="../../views/adminespecialidades.php" class="btn btn-secondary">Regresar</a>
                </form>
            </div>
        </div>
    </div>
