...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nombre) && !empty($fecha_ingreso)) {
        ...
        $sql = "INSERT INTO paralelos (nombre, fecha_ingreso)
                VALUES ('$nombre', '$fecha_ingreso')";
                
        if (mysqli_query($conn, $sql)) {
            header("Location: ../../views/admin/paralelo.php");
...
<head>
    ...
    <title>Agregar Paralelo| Sistema de Gestión UEBF</title>
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Agregar Paralelos</h5>
            </div>
            <div class="card-body">
                <form action="agregar_paralelo.php" method="post" enctype="multipart/form-data"
                    ...
                    <a href="../../views/admin/paralelo.php" class="btn btn-secondary">Regresar</a>
                </form>
            </div>
        </div>
    </div>
