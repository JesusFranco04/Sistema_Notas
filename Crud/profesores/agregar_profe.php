...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nombres) && !empty($apellidos) && !empty($cedula) && !empty($telefono) && !empty($correo_electronico) && !empty($rol) && !empty($contrasena) && !empty($date_creation)) {
        ...
        $sql = "INSERT INTO profesores (nombres, apellidos, cedula, telefono, correo_electronico, direccion, fecha_nacimiento, genero, discapacidad, rol, contrasena, archivo, date_creation)
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Agregar Profesor</h5>
            </div>
            <div class="card-body">
                <form action="agregar_profe.php" method="post" enctype="multipart/form-data"
                    ...
                    <a href="../../views/admin/profesores.php" class="btn btn-secondary">Regresar</a>
                </form>
            </div>
        </div>
    </div>
