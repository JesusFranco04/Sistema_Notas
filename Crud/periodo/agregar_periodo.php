...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($ano) && !empty($fecha_ingreso)) {
        ...
        $sql = "INSERT INTO periodo (ano, fecha_ingreso)
                VALUES ('$ano', '$fecha_ingreso')";
                
        if (mysqli_query($conn, $sql)) {
            header("Location: ../../views/admin/periodo.php");
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Agregar Periodo</h5>
            </div>
            <div class="card-body">
                <form action="agregar_periodo.php" method="post" enctype="multipart/form-data"
                    ...
                    <a href="../../views/admin/periodo.php" class="btn btn-secondary">Regresar</a>
                </form>
            </div>
        </div>
    </div>
