...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($nombre) && !empty($fecha_ingreso)) {
        ...
        $sql = "INSERT INTO niveles (nombre, fecha_ingreso)
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Agregar Niveles</h5>
            </div>
            <div class="card-body">
                <form action="agregar_niveles.php" method="post" enctype="multipart/form-data"
                    ...
                    <a href="../../views/admin/nivel_admin.php" class="btn btn-secondary">Regresar</a>
                </form>
            </div>
        </div>
    </div>
