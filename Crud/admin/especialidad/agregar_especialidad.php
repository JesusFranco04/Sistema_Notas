...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($nombre) && !empty($estado)) {
        $query = "INSERT INTO especialidad (nombre, estado, usuario_ingreso, fecha_ingreso) 
                  VALUES (?, ?, ?, ?)";
    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Formulario de Registro de Especialidad</h5>
            </div>
            <div class="card-body">
                <form action="http://localhost/sistema_notas/Crud/guardar_especialidad.php" method="POST"
