            ...
            <form action="" method="POST" onsubmit="return validarFormulario()">
                ...
                <div class="button-group mt-4">
                    <button type="button" class="btn btn-secondary"
                        onclick="location.href='http://localhost/sistema_notas/views/admin/especialidades.php;"><i
                            class='bx bx-arrow-back'></i> Regresar</button>
                    <button type="submit" class="btn btn-primary"><i class='bx bx-save'></i> Crear Especialidad</button>
                </div>
            </form>
        </div>
    </div>
