...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM paralelos WHERE id='" . $id . "'";
...
<div>
    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
        ...
        <a href="../../views/admin/paralelo.php">Regresar</a>
    </form>
</div>
<?php
    } else {
...
if (isset($_POST['actualizar'])) {
    ...
    if (!empty($nombre) && !empty($fecha_ingreso)) {
        ...
        $sql2 = "UPDATE paralelos SET nombre=?, fecha_ingreso=? WHERE id=?";
...
<head>
    ...
    <title>Editar paralelo | Sistema de Gestión UEBF</title>
